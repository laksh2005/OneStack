...
const DevOps = () => {
  ...
  useEffect(() => {
    ...
    setProgress(Math.round((completedTopicsCount / topics.length) * 100));
  }, [topics]);
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-8">
          <Link 
            to="/domains" 
            className="absolute top-0 left-0 flex items-center space-x-2 text-gray-600 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400 transition-colors"
          >
          ...
          <div className="text-center pt-12">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Master modern DevOps practices and automation tools
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-3xl font-bold text-red-600 dark:text-red-400">{progress}%</span>
              </div>
              <ProgressBar 
                value={progress} 
                color={domainColor} 
                      ...
                      <input
                        ...
                        onChange={() => {
                          ...
                          updateTopics(newTopics)
                            .then(() => {
                              const completedTopicsCount = newTopics.filter(t => t.completed).length;
                              setProgress(Math.round((completedTopicsCount / newTopics.length) * 100));
                            })
                            .catch((error) => {
                              console.error('Failed to update progress:', error);
                            });
                        }}
                        className="w-5 h-5 text-red-600 rounded border-gray-300 focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600"
                      />
                    </div>
                  </div>
                ))}
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">Docker</span>
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">Kubernetes</span>
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200">Jenkins</span>
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200">Terraform</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
              ...
              <div className="mb-8">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-red-600 dark:text-red-400 mr-4" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd" />
                  </svg>
                  <div>
                    <div className="font-medium text-gray-900 dark:text-white">Kubernetes Docs</div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">Container Orchestration Guide</div>
                  </div>
                </a>
              </div>
              ...
              <div>
                ...
                <div className="grid gap-4">
                  ...
                  >
                    <img 
                      src={`https://img.youtube.com/vi/j5Zsa_eOXeY/maxresdefault.jpg`}
                      alt="DevOps Course"
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent">
                      <div className="text-white text-sm font-medium">FreeCodeCamp - DevOps Course</div>
                    </div>
                  </a>
