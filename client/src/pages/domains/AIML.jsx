...
const domainName = "AI & Machine Learning";
const domainColor = "bg-pink-500";

const defaultTopics = [
  { id: 1, name: "Introduction to AI & ML", completed: false },
  { id: 2, name: "Python for ML", completed: false },
  { id: 3, name: "Data Preprocessing", completed: false },
  { id: 4, name: "Supervised Learning", completed: false },
  { id: 5, name: "Unsupervised Learning", completed: false },
  { id: 6, name: "Deep Learning Basics", completed: false },
  { id: 7, name: "Neural Networks", completed: false },
  { id: 8, name: "Computer Vision", completed: false },
  { id: 9, name: "Natural Language Processing", completed: false },
  { id: 10, name: "Reinforcement Learning", completed: false },
  { id: 11, name: "Model Deployment", completed: false },
  { id: 12, name: "AI Ethics", completed: false },
];
...
const AIML = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-900/40 dark:to-pink-800/40 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header Section */}
        <div className="relative mb-8">
          <Link 
            to="/domains" 
            className="absolute top-0 left-0 flex items-center space-x-2 text-gray-600 dark:text-gray-300 hover:text-pink-600 dark:hover:text-pink-400 transition-colors"
          >
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-black rounded-2xl shadow-lg p-6 backdrop-blur-sm bg-opacity-80 dark:bg-opacity-40">
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-3xl font-bold text-pink-600 dark:text-pink-400">{progress}%</span>
              </div>
              <ProgressBar 
                value={progress} 
                color={domainColor} 
                  ...
                  >
                    ...
                    <div className="ml-4">
                      <input
                        ...
                        className="w-5 h-5 text-pink-600 rounded border-gray-300 focus:ring-pink-500 dark:focus:ring-pink-600 dark:ring-offset-gray-800 dark:bg-gray-900 dark:border-gray-600"
                      />
                    </div>
                  </div>
                ))}
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-black rounded-2xl shadow-lg p-6 backdrop-blur-sm bg-opacity-80 dark:bg-opacity-40">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200">TensorFlow</span>
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200">PyTorch</span>
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-pink-100 dark:bg-pink-900 text-pink-800 dark:text-pink-200">Scikit-learn</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-black rounded-2xl shadow-lg p-6 backdrop-blur-sm bg-opacity-80 dark:bg-opacity-40">
              ...
              <div className="mb-8">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-pink-600 dark:text-pink-400 mr-4" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd" />
                  </svg>
                  <div>
                    <div className="font-medium text-gray-900 dark:text-white">Scikit-learn</div>
                ...
                <div className="grid gap-4">
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent">
                      <div className="text-white text-sm font-medium">Complete Machine Learning Course</div>
                    </div>
                  </a>
                </div>
              </div>
